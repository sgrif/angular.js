/**
 * @license AngularJS v1.3.0-local+sha.1f912eb
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.1f912eb/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-local+sha.1f912eb',    // all of these placeholder strings will be replaced by grunt's
